# /home/idec2/stanfordcar/test2_fixed.py
...
class ResNet18_MemristorHead(nn.Module):
    ...
    def forward(self, x):               # <-- REQUIRED forward (present!)
...
def main():
    ...
    epochs = 50           # quick check; increase later
    lr = 1e-3
    ...
    paths = {
        ...
        "Non spikes_2": {
            "pot": os.path.join(LUT_ROOT, "Non spikes_2_depression.txt"),
            "dep": os.path.join(LUT_ROOT, "Non spikes_2_potentiation.txt"),
        },
